...
describe('Start Check-in Journey', () => {
  ...
  it('should allow simulate aws rekogntion checks (photo match and liveness pass)', () => {
  ...
  it('should allow simulate aws rekogntion checks (photo match and liveness fail)', () => {
  ...
  it('should allow simulate aws rekogntion checks (photo mis-match and liveness success)', () => {
  ...
  it('should allow simulate aws rekogntion checks (photo mis-match and liveness fail)', () => {
